      ...
      <div className="w-full px-6 py-6 space-y-6">
        ...
        <div className="flex items-center justify-between gap-4 sticky top-0 backdrop-blur py-3 z-10 border-b border-zinc-800/60">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-md bg-brand-600 hover:bg-brand-500 disabled:bg-zinc-800 disabled:text-zinc-600 disabled:cursor-not-allowed text-white text-sm font-medium transition-colors shadow-lg shadow-brand-500/20 shrink-0"
          >
