...
import { dataBR, ehSemNome, montarTituloPadrao, tituloPadraoLiberado } from './titulo-padrao.js';
...
test('montarTituloPadrao: primeiro do dia sem número, os seguintes numerados', () => {
